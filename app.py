...
def index():
    if request.method == 'POST':
       ...
       # Get the current script's directory
        ...
        return render_template('ssd_failure_prediction.html', prediction=True)
    else:
        return render_template('ssd_failure_prediction.html', prediction=False)
...
def hdd_failure_prediction_result():
    return render_template('ssd_failure_prediction_result.html')
